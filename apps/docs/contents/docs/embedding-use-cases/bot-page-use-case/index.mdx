...
# Embedding MicroStrategy Bot Consumption Page

This guide demonstrates how to embed a MicroStrategy Bot Consumption Page into your React application using the `embed-dossier-mstr-react` package.
