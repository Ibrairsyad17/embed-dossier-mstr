...
# LibraryPageEmbed Component

The `LibraryPageEmbed` component allows you to embed the entire MicroStrategy Library page interface into your React application. This provides users with access to all available dashboards, documents, and other MicroStrategy content directly within your application's UI, maintaining a consistent user experience.
