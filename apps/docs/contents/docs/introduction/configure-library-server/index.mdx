---
title: Setup & Configure Library Server For Embedding
description: Setting up and configuring library server to use Embedding SDK on a different domain from your MicroStrategy environment, with enable Cross-Origin Resource Sharing (CORS) and allow SameSite cookies.
keywords:
  [
    "setup",
    "configuration",
...
If you plan to use Embedding SDK on a different domain from your MicroStrategy environment with `embed-dossier-mstr-react` in your React application, you'll need to meet the following requirements.

This guide is based on the MicroStrategy Embedding SDK Documentation. For complete details, please refer to the [official documentation](https://microstrategy.github.io/embedding-sdk-docs/config).
...
3. Choose the appropriate setting for **Allow Library embedding in other sites** to reconfigure CORS.
   ...
   ![Library Admin CORS Setting](https://microstrategy.github.io/embedding-sdk-docs/assets/images/LibraryAdmin_CORSsetting-3639c5dcf59048d1e393e62e30b664c6.png)
...
![SameSite Cookie](https://microstrategy.github.io/embedding-sdk-docs/assets/images/SameSiteCookie-0c732b3aa02b21ddfa0053f97e462f13.png)
...
2. In `[Tomcat Folder]\webapps\MicroStrategyLibrary\WEB-INF\web.xml`, change `sameSite` param-value blow to `NONE` to permit embedding.
...
3. Ensure your Tomcat is configured to support HTTPS.
4. Restart Tomcat.
...
![The default Chrome preference](https://microstrategy.github.io/embedding-sdk-docs/assets/images/chrome-preference-ed6cd64b42fb383d8d505b4f294e9227.png)
...
![The partitioned cookie setting](https://microstrategy.github.io/embedding-sdk-docs/assets/images/partitioned-cookie-d857ff72da8aade1554ef079c8902a88.png)
